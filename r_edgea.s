...
#include "asm_draw.h"
	...
	.data
Ltemp:					.long	0
float_1_div_0x100000:	.long	0x35800000	// 1.0/(float)0x100000
float_point_999:		.double	0.999
float_1_point_001:		.double	1.001
...
// Do 1/z sorting to see if we've arrived in the right position
	...
	fmuls	float_1_div_0x100000 // fu = (float)(edge->u - 0xFFFFF) *
								//      (1.0 / 0x100000);
	...
	fld		%st(2)				// newzi | fv*surf2->d_zistepv |
								//  fu*surf2->d_zistepu | newzi | fu
	fmull	float_point_999		// newzibottom | fv*surf2->d_zistepv |
								//  fu*surf2->d_zistepu | newzi | fu
...
//     goto Lgotposition;
	...
	fmull	float_1_point_001	// newzitop | testzi | fu
